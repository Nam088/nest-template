...
// Prettier is automatically integrated and will read config from .prettierrc
...
export default createNestJSConfig({
  ...
  rules: {
    ...
    // Disable lodash prefer-lodash-method rule
    'lodash/prefer-lodash-method': 'off',
    
    // Disable sonarjs cognitive-complexity rule
    'sonarjs/cognitive-complexity': 'off',
    
    // Prettier integration (automatically enabled via eslint-plugin-prettier/recommended)
    // It will automatically read config from .prettierrc
